...
# describe "/square/results/?[SOME INPUT NAME]=[NUMBER TO BE SQUARED]" do
...
# describe "/square_root/results/?[SOME INPUT NAME]=[NUMBER TO FIND THE SQUARE ROOT OF]" do
#   it "works with an input of 5", points: 2, hint: h("params_are_strings") do
...
# describe "/square/results/?[SOME INPUT NAME]=[NUMBER TO FIND THE SQUARE ROOT OF]" do
...
# describe "/payment/results/?[SOME INPUT NAME]=[BASIS POINTS]&[OTHER INPUT NAME]=[NUMBER OF YEARS]&[ANOTHER INPUT NAME]=[PRINCIPAL]" do
...
#   it "formats large dollar amounts when form is submitted", points: 2, hint: h("number_to_currency") do
...
# describe "/payment/new" do
#   it "formats the rate as a percentage when form is submitted", points: 1, hint: h("number_to_percentage") do
#     visit "/flexible/payment/410/30/250000"
...
#   it "creates a constrained random number when minumun number is 1 and maximun is 10.", points: 1 do
#     visit "/flexible/random/1/10"

#     pattern = /A random number between 1 and 10 is (\d+)/i
#     matched_groups = pattern.match(page.text)
#     first_matched_number = matched_groups[1].to_i
#     expect(first_matched_number).to be be_between(1, 10)
